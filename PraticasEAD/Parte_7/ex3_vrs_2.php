...
<body>
    ...
    <form action="ex3_vrs_2.php" method='post'>
        <div class="box-dados">
            <div class="dados-1">
    ...
    <?php if(
        isset($totalGanhos) && $totalGanhos != '' &&
        isset($totalPerdas) && $totalPerdas != '' &&
        isset($lucroReal) && $lucroReal != '' &&
        isset($lucroJaneiro) && $lucroJaneiro != '' &&
        isset($lucroFevereiro) && $lucroFevereiro != '' &&
        isset($lucroMarco) && $lucroMarco != '' &&
        isset($lucroAbril) && $lucroAbril != '' &&
        isset($lucroMaio) && $lucroMaio != '' &&
        isset($lucroJunho) && $lucroJunho != '' &&
        isset($lucroJulho) && $lucroJulho != '' &&
        isset($lucroAgosto) && $lucroAgosto != '' &&
        isset($lucroSetembro) && $lucroSetembro != '' &&
        isset($lucroOutubro) && $lucroOutubro != '' &&
        isset($lucroNovembro) && $lucroNovembro != '' &&
        isset($lucroDezembro) && $lucroDezembro != ''
        ){ 
    ?>
